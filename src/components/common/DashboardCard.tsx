...
const DashboardCard: React.FC<DashboardCardProps> = ({
	...
	return (
		<div className={`group relative bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300 hover:-translate-y-1 ${className}`}>
			<div className="flex items-start justify-between mb-4">
				<div className={`p-3 rounded-2xl ${selectedColor.bg} ${selectedColor.text} transition-colors group-hover:${selectedColor.iconBg} group-hover:text-white`}>
					{icon}
				</div>
				{trend && (
